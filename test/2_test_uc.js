...
let req_res_arr = [
  ...
  {no:9, action:'new_horse', reqData:{name: 'X', remarks: 'reject!!'}, success:false, errorMsg: "Internal error: name: 'X' length out of bounds (2-20)"},
  {no:10, action:'edit_horse', reqData:{name: 'X', remarks: 'reject!!'}, success:false, errorMsg: "Internal error: name: 'X' length out of bounds (2-20)"},
  ...
  {no:18, action:'new_horse', reqData:{name: 'Reject4Reject4Reject4Reject4', remarks: ''}, success:false, errorMsg: "Internal error: name: 'Reject4Reject4Reject4Reject4' length out of bounds (2-20)" } ,
  {no:19, action:'edit_horse', reqData:{name: 'Reject4Reject4Reject4Reject4', remarks: ''}, success:false, errorMsg: "Internal error: name: 'Reject4Reject4Reject4Reject4' length out of bounds (2-20)"
  } ,
  {no:20, action:'new_horse', reqData:{
    ...
    }, success:false, errorMsg: "Internal error: remarks: 'asdfasgfadsgsadgwqetgfwefvxxcvsfwserfew asdfasgfadsgsadgwqetgfwefvxxcvsfwserfew asdfasgfadsgsadgwqetgfwefvxxcvsfwserfew asdfasgfadsgsadgwqetgfwefvxxcvsfwserfew asdfasgfadsgsadgwqetgfwefvxxcvsfwserfew asdfasgfadsgsadgwqetgfwefvxxcvsfwserfew' length out of bounds (0-200)"},
